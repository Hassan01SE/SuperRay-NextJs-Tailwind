...
export default function Home() {
  return (
    <div className="min-h-screen  w-full ">
      ...
      <div id="banner" className=" flex flex-col-reverse items-center justify-evenly w-full mt-20 h-unit-8xl sm:p-12 p-4 bg-blue-900 sm:flex-row sm:items-start sm:justify-normal">

        <div className="w-full flex flex-col justify-evenly items-center max-h-full sm:w-3/4 sm:items-start">
          <h1 className="text-4xl text-center font-semibold sm:text-5xl sm:text-start md:text-6xl lg:text-8xl">Welcome to SuperRay</h1>
          <p className="max-w-md text-center text-sm mt-4 text-slate-300 sm:text-start sm:w-1/2 sm:mt-6 sm:text-md lg:text-lg">GAN Powered Platform For Super Resolution
