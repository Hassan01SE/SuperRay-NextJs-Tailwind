...
const Loading = () => {
    return (
        <div className="grid place-content-center w-full min-h-screen z-[99] overflow-hidden  dark:bg-blue-800 bg-black">
            {/* <h2 className="text-4xl text-white">Loading ..</h2> */}

            <div className="flex flex-col items-center animate-splash max-w-full">
