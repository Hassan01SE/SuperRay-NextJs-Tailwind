    ...
    return (
        <div className="w-full min-h-screen mt-20 mx-6  ">
            ...
            <div className="flex flex-col w-full">
                <h1 className=" text-5xl text  font-semibold mt-4 text-center text-white md:text-6xl">Our Aim</h1>

                <figure class=" mt-6 mb-12">
                    <blockquote class="relative rounded-3xl bg-gradient-to-r from-blue-400 to-blue-900 hover:from-blue-600 hover:to-blue-900 py-12 pl-14 pr-8 dark:bg-blue-900 dark:from-blue-900 dark:to-blue-900 dark:hover:from-blue-900 dark:hover:to-blue-900 ease-linear">
                        <p
                ...
                <div id="problemstatement" className=" mt-2 w-full h-unit-7xl">
                ...
                <Divider className="my-2 mx-16  self-center  dark:bg-slate-400 bg-white"></Divider>
                <div id="team" className=" mt-2 w-full h-unit-7xl">
