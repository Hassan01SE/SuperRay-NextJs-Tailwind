...
const LoginForm = () => {
    ...
    return (
        <form onSubmit={handleSignIn} className="dark flex flex-col flex-grow w-3/4 h-1/2 items-center justify-around sm:w-3/4 md:w-1/2">
            ...
            {isCredError && <div class="flex items-center p-4 mb-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
